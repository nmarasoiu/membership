...
* CLASS NAME: Member
*
* DESCRIPTION: Class representing a members in the distributed system
*/
...
public:
    ...
    Address addr;
    // boolean indicating if this members is up
    bool inited;
    // boolean indicating if this members is in the group
    bool inGroup;
    // boolean indicating if this members has failed
    bool bFailed;
